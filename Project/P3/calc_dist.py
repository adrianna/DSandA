...
##############
# Distance Between each Node to Neighbor on Graph (select distances)
d8to14 = dist(graph.intersections[8], graph.intersections[14])
print("G: dist(8,14): {}".format(d8to14))

d8to33 = dist(graph.intersections[8], graph.intersections[33])
print("G: dist(8,33): {}".format(d8to33))

d8to30 = dist(graph.intersections[8], graph.intersections[30])
print("G: dist(8,30): {}".format(d8to30))

d30to33 = dist(graph.intersections[30], graph.intersections[33])
print("G: dist(30,33): {}".format(d30to33))

#############
# h for each node: Estimated (fixed) distance From each Node to Goal
h8to14 = dist(graph.intersections[8], graph.intersections[14])
print("H: dist(8,14): {}".format(h8to14))

h33to14 = dist(graph.intersections[33], graph.intersections[14])
print("H: dist(33,14): {}".format(h33to14))

h30to14 = dist(graph.intersections[30], graph.intersections[14])
print("H: dist(30,14): {}".format(h30to14))

#############
# f for each node: Total Cost of path
8>>14
g8to14 = 0 ## How to handle this one?
f8to14 = g8to14 + h8to14
print("F: dist(8,14): {}".format(f8to14))

#8>>33
g8to33 = d8to33
print("G [8>>33]: g8to33: {}".format(g8to33))
f8to33 = g8to33 + h33to14
print("F [8>>33]: dist(8,33): {}".format(f8to33))

# 8>>33>>30
g8to33 =  d8to33 + d30to33
print("G [8>>33>>30]: g8to33: {}".format(g8to33))
f8to30 = g8to33 + h30to14
print("F [8>>33>>30]: dist(8,30): {}".format(f8to30))

#8>>33>>30>>14
g8to30 = g8to33 + d30to33
print("G [8>>33>>30>>14]: g8to30: {}".format(g8to30))
f8to14 = g8to30  + h30to14
print("F [8>>33>>30>>14]: dist(8,14): {}".format(f8to14))
